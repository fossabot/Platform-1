...
/*
 * Returns a response json formatted for VotePen's public API. Note that all errors have the same format;
 * making it easy for fornt-end developers writing code on top of VotePen's API. Happy API coding!
 *
