export default {
    ...
    items: [
        ...
        },
        {
            id: 'feed',
            title: 'Feed:',
            body: `<p>Your feed/homepage is your best friend on VotePen. It is where you find all the cool stuff posted to VotePen.</p>
        ...
        },
        {
            ...
            body: `<p>Last but not least, click on "Allow" to turn on web push notifications for VotePen to receive notifications in your OS when VotePen is not the active tab in your browser. (like when you have minimized the browser to watch Game of Thrones!)</p>
            <p><strong>Note:</strong> Unlike other websites, we do not bother you. We only send push notifications when VotePen is present in your browser.  </p>`
        }
    ]
};
