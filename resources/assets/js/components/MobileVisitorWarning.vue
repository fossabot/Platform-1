<template>
    ...
    >
        <p>
            Since beta 2.0, VotePen's web client is no longer mobile-friendly. Instead, we are focusing on developing native mobile apps to bring a truly outstanding experience for our mobile using users. 
        </p>
